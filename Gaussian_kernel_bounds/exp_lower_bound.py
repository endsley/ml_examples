...
#plt.axvline(-np.sqrt(2), linestyle='--')
plt.title('Gaussian Lower Bound via 1st order Taylor Expansion')
plt.rcParams.update({'font.size': 18})
plt.text(-2.0,1.3,r'RBF kernel (Red) : $e^{-\frac{x^2}{2\sigma^2}}$')
plt.text(-2.0,1.1,r'RBF lower bound (Blue) : $1 - \frac{x^2}{2\sigma^2}$')
