...
if __name__ == "__main__":
	...
	#
	jprint('Notice that the eigenvectors of K is not the same as Tn!!!')
	jprint('However if we multiply the eigenvalues by n, they become the same.\n')
#
#
	nσ = n*σ[0:3]
	...
	jprint('Therefore, we conclude that σ(K) = n*σ(Tn), we next verify the eigenvector eigenfunction relationship.\n')
	jprint('We first show the eigenvectors of K and eigenfunctions from Tn.')
#
