...
x = [1, 2, 3, 4, 5]
run_times = 1
KDAC = np.log(run_times*np.array([0.71, 516, 909.6, 894, 29088]))
ISM = np.log(np.array([0.01, 3.6, 0.35, 0.78, 18.56]))
GPU = np.log(run_times*np.array([0.023, 6.49, 3.8, 134, 600]))
Orthogonal = np.log(run_times*np.array([0.07, 3.4, 0.3, 0.68, 16.73]))
labels = ['4 Small\nGaussians', '4 Large\nGaussians', 'Moon no\nnoise', 'Moon with\nnoise', 'Face image\ndata']
