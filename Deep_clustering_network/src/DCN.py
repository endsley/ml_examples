...
class DCN:
	...
	def calc_Kernel(self, kernel_type, kernel_input):
	...
	def update_kernel(self):									#	update the kernel(i,j) value to y_i.T.dot(y_j)
		pass
...
#		self.loop = True
#
#		self.allocation = self.get_clustering_results()
